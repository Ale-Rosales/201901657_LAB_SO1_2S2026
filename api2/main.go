...
func main() {
	...
	enrutador.HandleFunc(fmt.Sprintf("/api2/%s/call-api1", carnet), manejadorLlamada("API1", "VM1", api1URL))
	enrutador.HandleFunc(fmt.Sprintf("/api2/%s/call-api3", carnet), manejadorLlamada("API3", "VM2", api3URL))
