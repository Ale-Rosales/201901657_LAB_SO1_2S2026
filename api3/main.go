...
var (
	api1URL = "http://192.168.122.152:8081" // API1 vive en VM1
	api2URL = "http://192.168.122.152:8082" // API2 vive en VM1
)
...
func main() {
	...
	enrutador.HandleFunc(fmt.Sprintf("/api3/%s/call-api1", carnet), manejadorLlamada("API1", "VM1", api1URL))
	enrutador.HandleFunc(fmt.Sprintf("/api3/%s/call-api2", carnet), manejadorLlamada("API2", "VM1", api2URL))
